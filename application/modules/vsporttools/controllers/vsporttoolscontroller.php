...
class VsportToolsController extends MX_Controller
{
    ...
    public function __construct() 
    {
        ...
        $this->setSportsUploadPath      = realpath(APPPATH . '../../../upload');
        
        $this->setSportsUploadLocalPath = realpath(APPPATH . '../../images/');
    ...
    public function getPathUpload()
    {
         ...
         $subFolder = "3434";
           echo "<br/><br/>hi";
          //$targetDir = realpath(APPPATH . '../../images/').'/'.$mainFolder.'/'.$subFolder;
          
          $targetDir = $this->setSportsUploadLocalPath.DIRECTORY_SEPARATOR.$mainFolder.DIRECTORY_SEPARATOR.$subFolder;
          echo $targetDir." jkk";
    ...
    public function sportToolsFrmUpload()
    {
        ...
        */
        ...
        $targetDir = $this->setSportsUploadPath.DIRECTORY_SEPARATOR.$mainFolder.DIRECTORY_SEPARATOR.$subFolder;
        //$targetDir = $this->setSportsUploadLocalPath.DIRECTORY_SEPARATOR.$mainFolder.DIRECTORY_SEPARATOR.$subFolder;
    ...
    public function sportToolsFrmUpload_old()
    {
