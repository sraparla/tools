...
class Upload_Api extends REST_Controller 
{
    ...
    public function sendUploadErroEmail_post()
    {
        ...
        $body       .= "<p><strong>Type Of Browser: </strong> ".$typeOfBrowser."<strong>Error Info:</strong> ".$uploadErrCode. "  ".$uploadErrMsg."</p>";
    ...
    public function sendUploadEmail_post()
    {
        ...
        $body       .= "<p><strong>Type Of Browser </strong>:".$typeOfBrowser."<strong>Notes:</strong><br/> ".$notesName."</p>";
