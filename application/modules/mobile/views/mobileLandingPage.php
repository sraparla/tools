        ...
        <div data-role="page" id="inventory">
            ...
            <div data-role="content">
                <ul data-role="listview" data-divider-theme="b" data-inset="true">
                  ...
                  <li data-theme="c">
                        <a href="#searchItems" data-transition="slide">Items</a>
                    </li>
<!--                      <li data-theme="c">
        ...
        <!-- Start of third page inventory Locations -->
        <div data-role="page" id="searchItems">
            ...
            <div data-role="content">
                <ul id="autoCompleteItemDescription" data-role="listview" data-inset="true" data-filter="true" data-filter-placeholder="Find a Description..." data-filter-theme="d"></ul>
            </div>
            <!-- /content -->

        </div>
        <!-- End of third page inventory Locations -->
         
        <!-- start of fourth page ---------------------> 
        <div data-role="page" id="invItemDetailsPage">
            <div data-role="header"data-id="toolbar" data-position="fixed">
                <a href="#searchItems" data-icon="arrow-l">Back</a>
                <h1 id="inventoryItemIDHeadingPage"></h1> 
            </div>
            <div data-role="content">
                 <ul id="inventoryItemIDList" data-role="listview" data-inset="true" data-filter-theme="d">
                     ...
                     <li data-role="fieldcontain">
                        ...
                        <textarea cols="40" rows="14" name="description" id="description"></textarea>
                     </li>
                     <li data-role="fieldcontain">
                         <!--Value = t_InvType OH: Value Min: Value Max: Value -->
                        <label for="inventoryName">Inventory:</label>
                        <input type="text" name="inventoryName" id="inventoryName">
                     </li>
                </ul>
                <ul id="invBottomFrmList" data-role="listview" data-count-theme="c" data-inset="true">
                </ul>
            </div>
        </div>
        <!-- End of Fourth page inventory Locations -->
         ...
         <!-- Start of fourth page Items in inventory locations -->
             ...
             <div data-role="popup" id="addInvItemLocation" data-theme="a" class="ui-corner-all">
                 ...
                 <form name="addInvItemLocationFrm" id="addInvItemLocationFrm">
                     <div style="padding:10px 20px;">
                         ...
                         <input type="number" name="inventoryItemIDBasic" id="inventoryItemIDBasic">
                         ...
                         <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                             ...
                             <a id="incrementSlideDynamicByFiftyAdd" href="#" data-role="button" data-icon="plus" data-theme="b">50</a>
                         </div>
                         <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                 ...
                 <form name="editInvItemLocationFrm" id="editInvItemLocationFrm">
                     <div style="padding:10px 20px;">
                         ...
                         <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                             ...
                             <a id="incrementSlideDynamicByFiftyEdit" href="#" data-role="button" data-icon="plus" data-theme="b">50</a>
                         </div>
                         <div data-role="controlgroup" data-type="horizontal" data-mini="true">
         ...
         <!-- End of fourth page Items in inventory locations -->
