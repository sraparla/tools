...
<!--                        <a href="#searchFromJobNumber" data-transition="slide">From Job Number</a>-->
                        <a  id="searchByJobNum" href="#searchFromJobNumber" data-transition="slide">From Job Number</a>
                    </li>
                    <li data-theme="c">
...
<!--            <div data-role="footer">
        ...
        <div data-role="page" id="searchFromJobNumber">
            ...
            <section data-role="content">
                <ul id="findJobStausFromOrderID" data-role="listview" data-inset="true" data-filter="true" data-filter-placeholder="From Job Number..." data-filter-theme="d">
...
<!--                <input name="mydate" id="mydate" type="date" data-role="datebox"
                ...
                <br/><br/>
                <ul id="getDynamicJobStatusList" data-role="listview">
