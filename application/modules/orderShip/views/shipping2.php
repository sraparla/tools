                                    ...
                                    <fieldset>
                                        <legend> Ship To Contact Info</legend>
                                            <div class="controls">
                                                ...
                                                <span id="companyNameModalError" style="color: red; font-size:67.5%">*</span>
                                            </div>
                                            <div class="controls">
                                         ...
                                         <legend>Phone Info</legend>
                                            ...
                                            <div class="controls">
                                               <input type="text" class="input-large" name="phoneModal" placeholder="phone" id="phoneModal">
                                                <span id="phoneModalError" style="color: red; font-size:67.5%">*</span>
                                            </div>
                                           ...
                                           <legend>Address Info</legend>
                                               ...
                                               <div class="controls">
                                                  <input type="text" class="input-xlarge" placeholder="Address1" name="Address1Modal" id="Address1Modal">
                                                   <span id="Address1ModalError"  style="color: red; font-size:67.5%">*</span>
                                               </div>
                                               ...
                                               <div class="controls">
                                                 ...
                                                 </select>   <span id="stateModalError" style="color: red; font-size:67.5%">*</span>
                                               </div>

                                               <div class="controls">
                                                  <input type="text" class="input-medium" placeholder="zipCode" name="zipCodeModal" id="zipCodeModal">
                                                   <span id="zipCodeModalError" style="color: red; font-size:67.5%">*</span>
                                               </div>
