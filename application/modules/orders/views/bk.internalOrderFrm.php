...
<!--                              <label id="customerNameLabel" for="internalOrderCompanyName" class="col-md-2 col-sm-3 control-label">Company</label>-->
                                  <a id="customerNameLabel" class="col-md-2 col-sm-3 control-label">Company</a>
                                  <div class="col-md-4 col-sm-4">
...
<!--                                  <label id="contactNameLabel" for="contact" class="col-md-2 col-sm-3 control-label">Contact</label>-->
                                  <a id="contactNameLabel" class="col-md-2 col-sm-3 control-label">Contact</a>
                                  <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                               <div class="col-md-12 col-sm-12">
                                   <label for="orderType" class="col-md-2 col-sm-3 control-label">Order Type</label>
                                   <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label for="jobName" class="col-md-2 col-sm-3 control-label">Job Name</label>
                                  <div class="col-md-4 col-sm-4">
...
<!--                                  <label for="artLocation" class="col-md-2 col-sm-3 control-label">Art Location</label>-->
                                  <a id="artLocationLabel" class="col-md-2 col-sm-3 control-label">Art Location</a>
                                  <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label for="customerPurChaseOrderNumber" class="col-md-2 col-sm-3 control-label">Customer P.O.#</label>
                                  <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                   <label class="col-md-2 col-sm-3 control-label">P.O. TBD</label>
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label class="col-md-2 col-sm-3 control-label">Total Order Pricing</label>
...
<!--                                      <div class="col-xs-2">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label class="col-md-2 col-sm-3 control-label">Incomplete Pricing</label>
                                  <div class="col-md-9 col-sm-9">
                                      <div class="checkbox">
                                          <label>
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label for="proofDue" class="col-md-2 col-sm-3 control-label">Proof Due</label>
                                  <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label class="col-md-2 col-sm-3 control-label">Date Received</label>
                                  <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label for="customerPurChaseOrderNumber" class="col-md-2 col-sm-3 control-label">Service Level</label>
                                  <div class="col-md-4 col-sm-4">
...
<!--                                     <input type="text" class="form-control" name="serviceLevel" id="serviceLevel">-->
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label for="jobDue" class="col-md-2 col-sm-3 control-label">Job Due</label>
                                  <div class="col-md-4 col-sm-4">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12">
                                  <label for="jobDue" class="col-md-2 col-sm-3 control-label">On Press</label>
                                  <div class="col-md-4 col-sm-4">
