    var  readUrl            = "orderShip/ordershipcontroller/shipDet/"+orderID,
         ...
         fillCountry        = "orderShip/ordershipcontroller/OrderShipStatesGetCountryFromStatesTable",
         fillState          = "orderShip/ordershipcontroller/OrderShipStatesGetStatesFromStatesTable",
         getState           = "orderShip/ordershipcontroller/OrderShipStatesGetStatesFromCountryChange",
         modalAddressUpdate = "orderShip/ordershipcontroller/orderShipAddressesModalAddressSubmit/";
 ...
 $(document).ready( function() {
                ...
                $('#mytable tbody tr').live('click',function(){
                                ...
                                //alert($("#receipeintCustomerID").val());
                ...
                $("#recipientTo").click(function(){
                          ...
                          {
                              //alert("update");
                              $("#reminderRecepientHeading").html("Your are editing the following receipient information: "); 
                              $("#reminderRecepientInfo").html(test);
                          }
                ...
                $("#closeRecipient").click(function(){ 
                          ...
                          // remove the validation rules
                           removeRules(updateCreateMainFrmRules);
                           removeRules(updateCreateMainBillToFrmRules);
                          return false;
                });
                ...
                $("#billAcountNumber").on('change keyup',function() {
                    if($("#billAcountNumber").val())
                    {
                       // remove the default rules
                       removeRules(updateCreateMainFrmRules);
                       
                       //add custom rules
                       addRules(updateCreateMainBillToFrmRules); 
                    }
                    else
                    {
                       if($("#billTo").val())
                       ...
                       else
                       {
                            ...
                            //add custom rules
                            addRules(updateCreateMainFrmRules);
                ...
                $("#billTo").change(function(){
                    var id = $(this).val();
                    if(id == "Recipient" || id == "Third Party")
                    {
                        // remove the default rules
                        removeRules(updateCreateMainFrmRules);
                ...
                // the modal window button is outside the form. 
                // So we need to have the click event to trigger the validation and submission.
                $("#validateModalAddress").click(function (){
                    //alert("hi3");
                    $("#updateFrmModalAddress").valid();
                    //alert("hi4");
                    $("#updateFrmModalAddress").submit();
                     //alert("hi5");
                });
                $("#countryModal").change(function() {
                        //alert("hi");
                        var id = $(this).val();
                        //alert(id);
                        //document.write(id);
                        ...
                        if(dataString == "ES")
                        {
                            $("#phoneModal").mask("(99)-9-999-99999? x99999");
                            $("#faxModal").mask("(99)-9-999-99999? x99999");
                            $("#mobileModal").mask("(99)-9-999-99999? x99999");
                            ...
                            removeRules(modalAddressRules);
                            removeRules(modalMexicoAddressRules);
                            removeRules(modalFranceAddressRules);
                            addRules(modalSpainAddressRules);
                        ...
                        if(dataString == "FR")
                        {
                            ...
                            removeRules(modalAddressRules);
                            removeRules(modalMexicoAddressRules);
                            addRules(modalFranceAddressRules);
                            //alert("u there");
                        ...
                        if(dataString == "MX")
                        {
                            ...
                            removeRules(modalAddressRules);
                            removeRules(modalFranceAddressRules);
                            addRules(modalMexicoAddressRules);
...
//                            
//                        },              
                        receipeintContactNameHidden:{
                                            required:true,
                                            messages: {
                                                        required: "*Contact Name* is missing"

                                            }
                                            

                        },
                        receipeintAddressNameHidden:{
                                            required:true,
                                            messages: {
                                                        required: "*Address1* is missing"

                                            }
                        },
                        receipeintCityNameHidden:{
                                            required:true,
                                            messages: {
...
//
//                        },
                        receipeintZipCodeNameHidden:{
                                            required:function() {
                                                return ($("[name='receipeintCountryNameHidden']").val() !== 'PA');
                                            }, 
                                            messages: {
                                                        required: "*ZipCode* is missing"
                ...
                var updateCreateMainBillToFrmRules = {
                        shipperInfo: {
                                            required:true
                        ...
                        receipeintStateNameHidden:{
                                            required:function() {
                                                return ($("[name='receipeintCountryNameHidden']").val() !== 'PA'&& $("[name='receipeintCountryNameHidden']").val() !== 'CR');
                                            }  ,
                                            messages: {
                                                        required: "*State Name* is missing"
...
//                        },
               ...
               function RefreshTable(tableId, urlData)
               {
                ...
                var updateModalForm = $("#updateFrmModalAddress").validate({
                    submitHandler:function(form) {
                        //alert("wass up1");
                        $.ajax({
                                url: modalAddressUpdate, 
                                type: 'POST',
                                data: $(form).serialize(),
                                success: function( response ) {
                                     //alert("wass up2");
                                    //--- clear form ---
                                    $("#updateFrmModalAddress").clearForm();
                                     //alert("wass up3");
                                    //alert("Modal Form Submitted Succesfully1");
                                    
                                    // close data Modal
                                    $('.modal').modal('hide');
                                    //alert("wass up4");
                                    // after updating the record in database refresh only the  DataTable 
                                    // (recipient or blind table depending on the posted value of #modalTypeSub.
                                    if($("#modalTypeSub").val() == "ShipTo")
                                    {
                                         //alert("wass up5");
                                         //alert(orderID);
                                        RefreshTable('#mytable','orderShip/ordershipcontroller/addressesRecipientDetails/'+orderID);
                                          //alert("wass up6");    
                                    }
                                    if($("#modalTypeSub").val() == "ShipBlindFrom")
                                    {
                                          //alert("wass up7");
                                        RefreshTable('#mytable_blind','orderShip/ordershipcontroller/addressesBlindDetails/'+orderID);
                                           //alert("wass up8");   
                                    }
                                    
                                    
                                    
                                    //alert("Modal Form Submitted Succesfully3");
...
//                });
                ...
                $( "#mytable" ).on( "click","a.editBtn",  function() {
                        ...
                        var countryEdit   = recipientInfo[4];
                        var stateEdit     = recipientInfo[5];
                        
                        //alert("addressID: "+addressID);
                        
                        // add the rules for validating the form:
                        //addRules(modalAddressRules);
                        ...
                        $.ajax({
                                url: 'orderShip/ordershipcontroller/orderShipAddressesGetModalAddressData'+'/'+addressID,
                                dataType: 'json',
                                success: function(response) {
                                    //alert("countryValue: "+$("#countryModal").val());
                                    ...
                                    //alert("response: "+response['t_Country']);

                                    if(response['t_Country'] == null)
                                    {
                                        countryEdit = "US";
                                        //alert("Contact IT : Country Value is Missing. No state Value Found! ");

                                    }
                                    else
                                    {
                                        countryEdit = response['t_Country'];
                                            
                                    }
                                    //alert("Country Name"+countryEdit);
                                    $.ajax({
                                            type:"GET",
                                            url: fillCountry+'/'+countryEdit,
                                            success: function(html) {
                                                    //Fill the second selection with the returned mysql data
                                                    $("#countryModal").html(html);
                                                    //$("#countryStateTable").val(ShipperID);
                                              }
                                    });
                                    $.ajax({
                                            type: "GET",  
                                            url: getState+'/'+countryEdit+'/'+response['t_StateOrProvince'],
                                            cache: false,
                                            success: function(html) {
                                            //Fill the second selection with the returned mysql data
                                            $("#stateModal").html(html);
                                    ...
                                    //alert(response['t_Country']);
                                    
                                    if(response['t_Country'] == "FR" || response['t_Country'] == "ES")
                                    {
                                        //alert("hi1");
                                         removeRules(modalAddressRules);
                                         removeRules(modalMexicoAddressRules);
                ...
                $( "#mytable_blind" ).on( "click","a.editBtn", function() {
                    
                        var blindEditInfoHref = $(this).attr('href' );
                        var blindEditInfo     = blindEditInfoHref.split("/");
                        var addressID         = blindEditInfo[0];
                        var customerID        = blindEditInfo[1];
                        var typeMain          = blindEditInfo[2];
                        var typeSub           = blindEditInfo[3];
                   
                        var countryBlindEdit  = blindEditInfo[4];
                        var stateBlindEdit    = blindEditInfo[5];
 ...
 //------------------------------------ Create a New OrderShip Record ---------------------------------------------------//               
                $("#createNew").on("click",function(){
                   ...
                   {
                              //alert("create");
                              $("#reminderRecepientHeading").html("Your are About to create a New receipient! ");
                              //$("#reminderRecepientInfo").html(test);
                    }
